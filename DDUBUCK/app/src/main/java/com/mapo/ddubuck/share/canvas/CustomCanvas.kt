...
class CustomCanvas(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : View(
    ...
    private val logoIconWhite = BitmapFactory.decodeResource(this.resources, R.drawable.logo_white)
    private val logoIconBlack = BitmapFactory.decodeResource(this.resources, R.drawable.logo_black)
