...
class CourseClearFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val AllCourseCount: TextView = rootView.findViewById(R.id.bottom_sheet_courseAllCount)
...
//                         setValueTextSize(30F)
    ...
    //  -- 산책 기록 API Call --
    fun setOneWeekRecordInfo(miniTitle: TextView ,AllCourseCount: TextView,courseUserName: TextView){
